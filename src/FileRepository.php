...
use Devel\Modules\Exceptions\InvalidAssetPath;
use Devel\Modules\Exceptions\ModuleNotFoundException;
use Devel\Modules\Process\Installer;
use Devel\Modules\Process\Updater;
...
abstract class FileRepository implements RepositoryInterface, Countable
{
    ...
    {
        return $this->config->get('devel-modules.' . $key, $default);
    }
