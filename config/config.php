...
use Devel\Modules\Activators\FileActivator;
...
return [
    ...
    */
    ...
    'stubs' => [
        'enabled' => false,
        'path' => base_path() . '/vendor/devel/modules/src/Commands/stubs',
        'files' => [
        ...
        'replacements' => [
            ...
            'routes/dashboard' => ['LOWER_NAME', 'DISPLAY_NAME', 'STUDLY_NAME', 'CONTROLLER_NAME', 'PERMISSION_GROUP'],
    ...
    'paths' => [
        ...
        */
        ...
        'assets' => public_path('devel-modules'),
